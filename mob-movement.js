...
(function () {
    ...
    const zombieScaledWidth = zombieScale * zombieWidth;
    const zombieScaledHeight = zombieScale * zombieHeight;
    let zombieXlocation = 25;
    let zombieYlocation = 80;
...
(function () {
    ...
    const zombieScaledWidth = zombieScale * zombieWidth;
    const zombieScaledHeight = zombieScale * zombieHeight;
    let zombieXlocation = 100;
    let zombieYlocation = 60;
...
(function () {
    ...
    const zombieScaledWidth = zombieScale * zombieWidth;
    const zombieScaledHeight = zombieScale * zombieHeight;
    let zombieXlocation = 175;
    let zombieYlocation = 55;
